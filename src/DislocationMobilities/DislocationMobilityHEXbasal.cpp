...
#ifndef _model_DislocationMobilityHEXbasal_cpp_
#define _model_DislocationMobilityHEXbasal_cpp_
...
namespace model
{
        ...
        /**********************************************************************/
        DislocationMobilityHEXbasal::DislocationMobilityHEXbasal(const double& b_SI,
                            const double& mu_SI,
                            const double& cs_SI,
        ...
        /**********************************************************************/
        DislocationMobilityHEXbasal::DislocationMobilityHEXbasal(const PolycrystallineMaterialBase& material) :
        ...
        /**********************************************************************/
        double DislocationMobilityHEXbasal::sigmoid(const double & x)
        {
            return 2.0/(1.0+exp(2.0*x));
        }
        
        /**********************************************************************/
        double DislocationMobilityHEXbasal::velocity(const MatrixDim& S,
                        const VectorDim& b,
                        const VectorDim& xi,
                        const VectorDim& n,
                        const double& T,
