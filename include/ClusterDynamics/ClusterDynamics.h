...
namespace model
{
    ...
    /*                   */, public ClusterDynamicsBase<dim>
    {
        ...
        typedef typename ClusterDynamicsBase<dim>::FiniteElementType FiniteElementType;
//        static constexpr int mSize=ClusterDynamicsParameters<dim>::mSize;
        ...
        typedef typename ClusterDynamicsBase<dim>::MobileTrialType MobileTrialType;
        typedef typename ClusterDynamicsBase<dim>::MobileGradType MobileGradType;
        typedef typename ClusterDynamicsBase<dim>::MobileFluxType MobileFluxType;
        ...
        typedef typename ClusterDynamicsBase<dim>::ImmobileTrialType ImmobileTrialType;

        
        typedef UniformController<mSize*dim> UniformControllerType;
        typedef std::map<size_t,const std::unique_ptr<UniformControllerType>> UniformControllerContainerType;
